...
public class EncEficiente {
    ...
    public EncEficiente(String nomeCliente, int nif, String morada, int nEnc, LocalDate data, ArrayList<LinhaEncomenda> encomendas) {
    ...
    public EncEficiente(EncEficiente encEficiente) {
        ...
        this.setEncomendas(encEficiente.getEncomendas());
    }
